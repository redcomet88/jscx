...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body id="userBody" style="display: none">
        <div id="formRole" style="height:100%;left:5px;top:6px;border:1px solid #e0e0e0;background:#f3f3f4;">
            ...
            <input id="roles" name="roles" class="mini-hidden"/>
            <div style="width:50%;height:85%;float:left;">
                <table id="roleTable" border="0" cellpadding="10" cellspacing="2" style="width:100%;">
                    <tr>
                        ...
                        <td style="width:70%;">
                            <div id="roleName" class="mini-listbox" style="width:150px;height:230px;"
                                textField="roleName" valueField="id" showCheckBox="true" multiSelect="true"
                                url="<%=request.getContextPath()%>/ajax/role_getPiLiangRoleList.do">
        ...
        <script type="text/javascript">
            ...
            function save() {
                ...
                var role = mini.get("roleName").getValue(true);
                if(role == "" || menu == "" ){
                     mini.alert("角色或权限没有选择！");
                     return;
                }
                mini.get("menu").setValue(menu);
                mini.get("roles").setValue(role);
                // 保存角色
                mini.confirm("是否保存角色权限？？", "确定？",function(action) {
                    if (action == "ok") {
                        $.ajax({
                            url: "<%=request.getContextPath()%>/ajax/role_saveRolePiLiang.do",
                            type: "post",
