    ...
    <div style="float:left;width:19%;height:80px;margin-right:1%;">
        <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td  class="td1"><span class="c">事件总数</span></td>
            </tr>
            <tr>
    ...
    <div style="float:left;width:19%;height:80px;margin-right:1%;">
        <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td class="td2"><span class="c">进行中</span></td>
            </tr>
            <tr>
    ...
    <div style="float:left;width:19%;height:80px;margin-right:1%;">
        <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td class="td3"><span class="c">已完成</span></td>
            </tr>
            <tr>
...
<div id="tabs" class="mini-tabs" activeIndex="0" style="width: 100%;height:88%;"  onactivechanged="onActiveChanged">
    <div title="总数量" id="totalSum" name="totalSum" style="width:100%;height:100%" >
        <table style="width:45%;height:5%">
            <tr>
                <td>&nbsp;&nbsp;&nbsp;</td>
                <td >
                    <div id="statisticTypeInpt" class="mini-radiobuttonlist" repeatItems="1" repeatLayout="flow" repeatDirection="vertical" value="totalNum"
                         textField="text" valueField="id" value="use"  data="[{id:'totalNum',text:'数量'},{id:'totalAmount',text:'扣分'}]" onvaluechanged="onstatisticTypeChanged">
                    </div>

                </td>
                <td style="text-align:right;">部门： </td>
                <td >
                    <input id="jgInpt" class="mini-treeselect" name="jgh" url="<%=request.getContextPath()%>/ajax/user_getJgList.do?" textField="jgmc" valueField='jgh' parentField="sjjg"
                           value="<%-- ${sessionScope.jgh} --%>" onvaluechanged="onJgChanged" style="width:100%;margin:0 0;padding:0 0" multiSelect="true"
                           checkRecursive="true" showFolderCheckBox="true" checkRecursive="true"/>
                </td>
                <td>&nbsp;&nbsp;&nbsp;</td>
            </tr>
        </table>
        <!-- 查询统计的饼图 -->
        <div id="summaryChart" style="margin:1% 1%;width:98%;height:85%" >  </div>
    </div>

    <div title="分类占比" id="zcProportion" name="zcProportion" style="width:100%;height:100%" >

        <!-- 查询统计的饼图 -->
        <div id="summaryChart2" style="margin:1% 1%;width:98%;height:100%" >  </div>
    </div>
</div>
