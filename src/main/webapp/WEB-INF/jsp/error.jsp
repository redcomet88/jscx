...
<body class="ie8">
<% Exception ex = (Exception)request.getAttribute("exception");String code = ex.getMessage(); %>
<div id="js-alert-box" class="alert-box">
    <svg class="alert-circle" width="234" height="234">
        ...
        <text class="alert-sec-unit" x="96" y="172" fill="#BDBDBD">秒</text>
    </svg>
    ...
    <div class="alert-body">
        ...
        <a id="js-alert-btn" class="alert-btn" onclick="gotoLogin()">立即返回登录页</a>
    </div>
